          ...
          <v-layout row wrap justify-center align-center>
            ...
            <v-flex xs4 sm2 pa-0>
              ...
              <a @click="$refs.photo_file.click()">
                <v-img src="~@/assets/duilian/button-photo-go.png"></v-img>
              </a>
            </v-flex>
            <v-flex xs4 sm2 pl-1 pr-4>
              <router-link to="/duilian/text">
                <v-img src="~@/assets/duilian/button-switch-to-text.png"></v-img>
              </router-link>
            </v-flex>
          </v-layout>
        </v-container>
...
<script lang="js">
import {
  DUILIAN_SET_GEN_METHOD, DUILIAN_SET_PHOTO_FILE
} from '@/mutation-types'
...
export default {
  ...
  data () {
    return {
      photoURL: require('@/assets/duilian/bg-photo-area.png'),
...
<style scoped lang="stylus">
  #wrapper
    background-image: url("~@/assets/duilian/bg-photo.png")
